...
const DEFAULT_CLIENTS_WRITE_RANGE = "Clients!A:L";
const DEFAULT_CONTACTS_WRITE_RANGE = "Contacts!A:P";
...
export function getGoogleWriteRanges(env: AppEnv) {
  return {
    ...
    actions: env.GOOGLE_ACTIONS_WRITE_RANGE || DEFAULT_ACTIONS_WRITE_RANGE,
